    ...
    return (
        <Box sx={{ width: '100%' }}>
            <Snackbar open={open} autoHideDuration={6000} onClose={handleClose}>
                <Alert onClose={handleClose} severity="error" sx={{ width: '100%', color: 'red' }}>
                    {errorMessage}
                </Alert>
            </Snackbar>
            ...
            {activeStep === steps.length ? (
                <React.Fragment>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
                        ...
                        <Button onClick={handleReset} sx={{color:'white'}} >Reset</Button>
                    </Box>
                </React.Fragment>
            ) : (
                <React.Fragment>
                    <div className='buttons'>
                        ...
                        >
                            <ArrowBackIcon className=' text-white' /><span style={{color:'white'}}>Back</span>
                        </Button>
